<!--
Vendored from Phaser 4.2.1 skills/v4-new-features/SKILL.md.
Upstream SHA-256: f254246385786aa15a91a3c359dee0118111adfb678b220f8ea5714551a3d1e1.
...
**Related skills:** ../v3-to-v4-migration/topic.md, ../filters-and-postfx/topic.md, ../game-object-components/topic.md, ../tilemaps/topic.md

> **Migrating from v3?** See the [v3 to v4 Migration Guide](../v3-to-v4-migration/topic.md) for step-by-step code changes, removed APIs, and a migration checklist.

## Contents

- [Overview: What Changed in v4](#overview-what-changed-in-v4)
- [Filters System (Replacing FX and BitmapMask)](#filters-system-replacing-fx-and-bitmapmask)
- [RenderNodes (Replacing Pipelines)](#rendernodes-replacing-pipelines)
...
For detailed configuration options, API reference tables, and source file maps, see [the reference guide](reference.md).
