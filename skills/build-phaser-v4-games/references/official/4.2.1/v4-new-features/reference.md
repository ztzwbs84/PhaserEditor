<!--
Vendored from Phaser 4.2.1 skills/v4-new-features/references/REFERENCE.md.
Upstream SHA-256: bfc233d581d25e9c4a7df21da1309793cfc1e31c58bce216f21f604ac23e6b1f.
...
For detailed migration instructions, code conversion examples, removed APIs, and a full checklist, see the dedicated [v3 to v4 Migration Guide](../v3-to-v4-migration/topic.md).
...
**Related skills**: ../filters-and-postfx/topic.md, ../game-object-components/topic.md, ../tilemaps/topic.md, ../v3-to-v4-migration/topic.md
