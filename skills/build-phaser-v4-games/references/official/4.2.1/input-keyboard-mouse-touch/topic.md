<!--
Vendored from Phaser 4.2.1 skills/input-keyboard-mouse-touch/SKILL.md.
Upstream SHA-256: 989eb1d4d103258caad4cc6806a47b337fd92f525fd7e30dc2214dbed08e172a.
...
**Related skills:** ../sprites-and-images/topic.md, ../events-system/topic.md, ../scenes/topic.md

## Contents

- [Quick Start (basic keyboard + pointer input)](#quick-start-basic-keyboard-pointer-input)
...
Pointer events fire at three levels (see [reference](reference.md#three-levels-of-pointer-events) for details):
