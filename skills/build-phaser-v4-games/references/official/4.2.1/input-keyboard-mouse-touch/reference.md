<!--
Vendored from Phaser 4.2.1 skills/input-keyboard-mouse-touch/references/REFERENCE.md.
Upstream SHA-256: 0142a82b5a0730ac6f2475df945cdd5d82ab477f68e6d17f72016c49bbe9ba1f.
...
- [Events (input events with callback signatures)](#events-input-events-with-callback-signatures)
- [API Quick Reference](#api-quick-reference)
- [Three Levels of Pointer Events](#three-levels-of-pointer-events)
- [Hit Area Shapes (All Geometry Types)](#hit-area-shapes-all-geometry-types)
- [Full setInteractive Config Object](#full-setinteractive-config-object)
- [Input Debug Mode](#input-debug-mode)
- [Multi-touch Configuration](#multi-touch-configuration)
- [Keyboard Combos (String Array Form)](#keyboard-combos-string-array-form)
- [Gamepad Additional Methods](#gamepad-additional-methods)
