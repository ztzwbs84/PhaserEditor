<!--
Vendored from Phaser 4.2.1 skills/events-system/SKILL.md.
Upstream SHA-256: 9453d165e0d61149fef3f10bfb6c7518ad943fb60389018c717322b4305962ab.
...
**Related skills:** ../scenes/topic.md, ../input-keyboard-mouse-touch/topic.md
...
- [All Event Namespaces Reference](#all-event-namespaces-reference)
- [Gotchas](#gotchas)
...
Emitter: `this.input` (scene-level) or individual GameObjects. Events exist at three levels: scene-level (`this.input`), scene-level with gameobject prefix, and directly on interactive GameObjects. See ../input-keyboard-mouse-touch/topic.md for full usage.
