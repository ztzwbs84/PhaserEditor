<!--
Vendored from Phaser 4.2.1 skills/graphics-and-shapes/SKILL.md.
Upstream SHA-256: 7e21c540d0b541c20a25f7d98ee1294edaf9af33f728b94f08e20c13ed621c04.
...
- [Core Concepts — Graphics vs Shape Objects](#core-concepts-graphics-vs-shape-objects)
- [Common Patterns](#common-patterns)
- [All Shape Types](#all-shape-types)
- [API Quick Reference — Graphics Methods](#api-quick-reference-graphics-methods)
- [Gotchas](#gotchas)
- [Shape-Specific Methods](#shape-specific-methods)
