<!--
Vendored from Phaser 4.2.1 skills/game-object-components/SKILL.md.
Upstream SHA-256: 3d973f213f4d14255e82a816441f53630fe8e44478d87665fce3532d0ed8e784.
...
- [Factory Registration and Display List](#factory-registration-and-display-list)
- [Gotchas](#gotchas)
...
For RenderNodes, RenderSteps, and FilterList details, see the [filters-and-postfx skill](../filters-and-postfx/topic.md) and [reference.md](reference.md).
...
For a full component-to-game-object matrix, see [reference.md](reference.md).
