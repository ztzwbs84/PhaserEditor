<!--
Vendored from Phaser 4.2.1 skills/game-setup-and-config/SKILL.md.
Upstream SHA-256: f21465f569131b677580550f8d1740f50f22ab64e3af7790f55fb16e32bf5428.
...
**Related skills:** ../scenes/topic.md, ../loading-assets/topic.md, ../scale-and-responsive/topic.md
...
- [Game Lifecycle, Pause/Resume, and Destroy](#game-lifecycle-pauseresume-and-destroy)
...
Only the first scene starts automatically. Others start only if they have `{ active: true }` in their scene config. See ../scenes/topic.md.
