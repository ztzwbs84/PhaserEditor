<!--
Vendored from Phaser 4.2.1 skills/loading-assets/SKILL.md.
Upstream SHA-256: d796b330331538fae7d93907cd9de21b60bf5832fd0128f3a1e2c396e07e1445.
...
**Related skills:** ../game-setup-and-config/topic.md, ../scenes/topic.md, ../sprites-and-images/topic.md
...
- [All File Types Reference](#all-file-types-reference)
- [Events](#events)
...
All `this.load` methods accept positional arguments or a single config object. They also accept an array of config objects to batch-load multiple files of the same type. See `reference.md` for the complete parameter table.
...
Cache sub-types: `this.cache.text`, `this.cache.json`, `this.cache.audio`, `this.cache.binary`, `this.cache.shader`, `this.cache.xml`. See `reference.md` for the full Cache API.

## Source File Map

See `reference.md` for the complete source file map and Cache API reference.
