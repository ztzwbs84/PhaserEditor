<!--
Vendored from Phaser 4.2.1 skills/loading-assets/references/REFERENCE.md.
Upstream SHA-256: 612d354cb8878cdbccbdaa99ea7dbd8a7a6e6af9f02a513c47d95f5c0f367973.
This is an on-demand reference, not a separately registered skill.
-->
# Loading Assets - Reference

Extended reference tables for the loading-assets skill. See `topic.md` for usage patterns and examples.
