<!--
Vendored from Phaser 4.2.1 skills/particles/SKILL.md.
Upstream SHA-256: f85397e8518eb80b7fc667aef3a542a3c260712c44c2e1d7f88e4d209bb9204c.
...
**Related skills:** ../sprites-and-images/topic.md, ../loading-assets/topic.md
...
See `reference.md` for the full source file map. Key entry points: `src/gameobjects/particles/ParticleEmitter.js` (main class), `src/gameobjects/particles/Particle.js` (individual particle), `src/gameobjects/particles/zones/` (zone classes).
