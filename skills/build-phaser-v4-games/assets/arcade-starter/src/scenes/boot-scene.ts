...
const ASSETS = [
  ...
  ['drone', 'assets/drone.svg'],
  ['shard', 'assets/shard.svg']
] as const
...
export class BootScene extends Phaser.Scene {
  ...
  private readonly onProgress = (progress: number) => {
  ...
  preload(): void {
    this.failedFiles = 0
    this.cameras.main.setBackgroundColor('#10171c')
