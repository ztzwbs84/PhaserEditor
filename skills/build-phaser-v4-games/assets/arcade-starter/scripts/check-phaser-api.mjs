...
const adjacentAnchorsFile = path.join(scriptDirectory, 'api-anchors.json');
const skillAnchorsFile = path.join(scriptDirectory, '..', 'references', 'api-anchors.json');
const defaultAnchorsFile = existsSync(adjacentAnchorsFile) ? adjacentAnchorsFile : skillAnchorsFile;
